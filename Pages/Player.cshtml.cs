...
namespace InventoryWebsite.Pages
{
    public class PlayerModel : PageModel
    {
        ...
        public PlayerModel(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContext, ILogger<IndexModel> _logger)
        {
        ...
        public async Task OnGetAsync(string player = "Blayze")
        {
            if (data is null)
            {
        ...
        public async Task PageLoad()
        {
            ...
            data.Add(currentPlayer, null);
        }
            if(WebSocketController._main is not null) {
                data[currentPlayer] = DoGetTask(WebSocketController._main, currentPlayer);
            }
            else {
